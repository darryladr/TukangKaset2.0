...
module.exports = async function (client, message, args) {
	...
	else return message.reply("This radio station was not found");
...
function stations(client, prefix, message) {
	...
	for (let i = 0; i < radios.EU.Germany.length; i++) {
		United_Kingdom += `**${i + 1 + 10 * amount}** [${radios.EU.United_Kingdom[i]
			.split(" ")[0]
	...
	for (let i = 0; i < radios.EU.Austria.length; i++) {
		austria += `**${i + 1 + 10 * amount}** [${radios.EU.Austria[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Austria[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Belgium.length; i++) {
		Belgium += `**${i + 1 + 10 * amount}** [${radios.EU.Belgium[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Belgium[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Bosnia.length; i++) {
		Bosnia += `**${i + 1 + 10 * amount}** [${radios.EU.Bosnia[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Bosnia[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Czech.length; i++) {
		Czech += `**${i + 1 + 10 * amount}** [${radios.EU.Czech[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Czech[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Denmark.length; i++) {
		Denmark += `**${i + 1 + 10 * amount}** [${radios.EU.Denmark[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Denmark[i].split(" ")[1]
		})\n`;
	}
	...
	let germany = "";
	for (let i = 0; i < radios.EU.Germany.length; i++) {
		germany += `**${i + 1 + 10 * amount}** [${radios.EU.Germany[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Germany[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Hungary.length; i++) {
		Hungary += `**${i + 1 + 10 * amount}** [${radios.EU.Hungary[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Hungary[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Ireland.length; i++) {
		Ireland += `**${i + 1 + 10 * amount}** [${radios.EU.Ireland[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Ireland[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Italy.length; i++) {
		Italy += `**${i + 1 + 10 * amount}** [${radios.EU.Italy[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Italy[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Romania.length; i++) {
		Romania += `**${i + 1 + 10 * amount}** [${radios.EU.Romania[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Romania[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Serbia.length; i++) {
		Serbia += `**${i + 1 + 10 * amount}** [${radios.EU.Serbia[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Serbia[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Spain.length; i++) {
		Spain += `**${i + 1 + 10 * amount}** [${radios.EU.Spain[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Spain[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Sweden.length; i++) {
		Sweden += `**${i + 1 + 10 * amount}** [${radios.EU.Sweden[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Sweden[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.TURKEY.length; i++) {
		TURKEY += `**${i + 1 + 10 * amount}** [${radios.EU.TURKEY[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.TURKEY[i].split(" ")[1]
		})\n`;
	}
	...
	for (let i = 0; i < radios.EU.Ukraine.length; i++) {
		Ukraine += `**${i + 1 + 10 * amount}** [${radios.EU.Ukraine[i].split(" ")[0].replace("-", " ")}](${
			radios.EU.Ukraine[i].split(" ")[1]
		})\n`;
	}
	...
	const infoembed = new Discord.MessageEmbed()
		...
		.setFooter(client.user.username, client.user.displayAvatarURL()).setDescription(`
